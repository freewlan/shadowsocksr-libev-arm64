...
ACLOCAL = ${SHELL} /root/ssr-origin/auto/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
ASCIIDOC = /usr/bin/asciidoc
AUTOCONF = ${SHELL} /root/ssr-origin/auto/missing autoconf
AUTOHEADER = ${SHELL} /root/ssr-origin/auto/missing autoheader
AUTOMAKE = ${SHELL} /root/ssr-origin/auto/missing automake-1.15
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /root/ssr-origin/auto/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MV = /bin/mv
NM = /usr/bin/nm -B
...
VERSION = 2.5.6
XMLTO = /usr/bin/xmlto
abs_builddir = /root/ssr-origin
abs_srcdir = /root/ssr-origin
abs_top_builddir = /root/ssr-origin
abs_top_srcdir = /root/ssr-origin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/ssr-origin/auto/install-sh
